...
#ifndef TIMSORT_RUSEV_H
#define TIMSORT_RUSEV_H


void timSort_Rusev(int* arr, unsigned int n);
void timSort_Rusev_With_Checks(int* arr, unsigned int n);

void timSort_Rusev_WithMerge(int* arr, unsigned int n);
void timSort_Rusev_With_Checks_imprMerge(int* arr, unsigned int n);


#endif // TIMSORT_RUSEV_H
